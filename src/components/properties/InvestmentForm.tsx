        ...
        return (
          ...
          >
            ...
            <div className="space-y-4">
              <div className="border border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-luxe-blue hover:bg-blue-50 transition-colors group cursor-pointer">
