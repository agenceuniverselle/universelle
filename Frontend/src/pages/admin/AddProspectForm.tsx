...
const AddProspectForm: React.FC = () => {
      ...
      case 1:
        return (
          <motion.div 
            ...
            className="space-y-4 py-2 dark:bg-gray-800 text-gray-800 dark:text-gray-200"
          >
            <div>
              <Label htmlFor="amount" className="text-base font-medium dark:text-white">
  ...
  <div className="grid grid-cols-2 gap-3 mt-2">
    ...
    >
      Autre
            ...
            <div className="mt-4">
  <Label htmlFor="participationType" className="text-base font-medium text-gray-900 dark:text-white">
  ...
  >
    <div className="flex items-center space-x-2 p-3 border rounded-md bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-gray-300 dark:border-gray-600">
      <RadioGroupItem value="passive" id="passive" />
      <Label htmlFor="passive" className="flex-1 cursor-pointer">
        <div className="font-medium text-gray-900 dark:text-white">Investisseur passif</div>
        <div className="text-sm text-gray-500 dark:text-gray-400">
          Investissement sans implication dans les décisions opérationnelles
        </div>
      </Label>
    </div>
    ...
    <div className="flex items-center space-x-2 p-3 border rounded-md bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-gray-300 dark:border-gray-600">
      ...
      <Label htmlFor="partner" className="flex-1 cursor-pointer">
        <div className="font-medium text-gray-900 dark:text-white">Partenaire</div>
        <div className="text-sm text-gray-500 dark:text-gray-400">
          Participation active aux décisions stratégiques du projet
        </div>
      </Label>
    </div>
    ...
    <div className="flex items-center space-x-2 p-3 border rounded-md bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors border-gray-300 dark:border-gray-600">
      ...
      <Label htmlFor="coDev" className="flex-1 cursor-pointer">
        <div className="font-medium text-gray-900 dark:text-white">Co-développement</div>
        <div className="text-sm text-gray-500 dark:text-gray-400">
          Implication directe dans le développement du projet
        </div>
      </Label>
    </div>
  </RadioGroup>
  ...
  return (
    ...
    >
      ...
      <div>
        <Label htmlFor="phone" className="text-base font-medium text-gray-900 dark:text-white">
          Téléphone
        </Label>
        <div className="mt-1 relative">
          <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
      ...
      <div>
        <Label htmlFor="nationality" className="text-base font-medium text-gray-900 dark:text-white">
          Nationalité
        </Label>
        <Select 
      ...
      <div>
        <Label htmlFor="address" className="text-base font-medium text-gray-900 dark:text-white">
          Adresse
        </Label>
        <Textarea
          id="address"
      ...
      <div className="mt-6">
        <Label htmlFor="comments" className="text-base font-medium text-gray-900 dark:text-white">
      ...
      <div className="mt-6">
        <div className="flex items-start space-x-2">
          ...
          />
          <Label htmlFor="consent" className="text-sm font-medium text-gray-800 dark:text-white">
            J'accepte les{" "}
            <a
  ...
  <div className="max-w-4xl mx-auto p-6">
    <div className="mb-6">
      ...
      <p className="text-gray-600 dark:text-gray-300 mt-2">
        Complétez les informations du prospect ci-dessous.
      </p>
    </div>

    <Card className="bg-white dark:bg-gray-900 shadow-lg border border-gray-200 dark:border-gray-700">
      <CardHeader>
        <CardTitle className="text-gray-900 dark:text-white">Informations du prospect</CardTitle>
